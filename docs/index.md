...
2. **Upload** the raw data to the TPR-DB
    1. The TPR-DB will **automatically process** the raw data:
        ...
        3. **PoS** tag the tokens and parse **syntactic dependencies**
        4. **Align** source and target **segments**
        5. (*optional*) Automatically **align** source and target **words**
        6. **Map keystrokes** to words
        7. **Map fixations** to words
